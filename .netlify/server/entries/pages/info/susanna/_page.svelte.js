...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="max-w-[50ch]"><h2 class="dark:text-[var(--dark-green)] text-[var(--light-green)] pb-5">Heissan Sinulle!</h2>
...
jonka valitset tueksi ja oppaaksi matkallesi.</p>
    ...
    <p class="pb-5">Terveydenhuollon rekisteröity hieroja Valvira/ Koulutettu hieroja 2001</p>
    <h4 class="bold">Kurssit</h4>
    ...
    <p class="pb-5">• Hyvinvointimessut Vimpelissä 2017 ja 2018</p>
    
    <p class="bold">Kirja, jonka olen kirjoittanut:</p>
    <p class="bold">Esikoisromaani</p>
    <p>Unikuvan saari, 2008</p>
    <p class="bold">Runokirja</p>
    <p>Sisältöä elämään, 2005</p></div>`;
});
export {
  Page as default
};
