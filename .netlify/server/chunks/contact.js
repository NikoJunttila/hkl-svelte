...
const css = {
  code: ".title.svelte-1s3xdd6{box-shadow:0px 6px 15px 1px #000;border-radius:25px;text-align:center}",
  map: null
};
const Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="flex flex-col justify-center items-center py-3"><div class="dark:bg-[var(--dark-green)] bg-[var(--light-green)] title sm:w-[300px] lg:w-[500px] py-1 svelte-1s3xdd6"><h3 class="px-3">Yhteystiedot</h3></div>
